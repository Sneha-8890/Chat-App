...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageHolder> {
    ...
    public MessageHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.message_layout_holder,parent,false);
    ...
    public void onBindViewHolder(@NonNull MessageHolder holder, int position) {
        ...
        if (messages.get(position).getSender().equals(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getEmail())){
            Glide.with(context).load(senderImg).error(R.drawable.ic_profilr).placeholder(R.drawable.ic_profilr).into(holder.profImage);
            ...
            Glide.with(context).load(receiverImg).error(R.drawable.ic_profilr).placeholder(R.drawable.ic_profilr).into(holder.profImage);
            ConstraintSet constraintSet = new ConstraintSet();
            constraintSet.clone(constraintLayout);
