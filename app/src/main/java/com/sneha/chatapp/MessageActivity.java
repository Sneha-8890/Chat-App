...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imgSend = findViewById(R.id.imgSendMessage);
        edtMessageInput = findViewById(R.id.edtText);
        TextView txtChattingWith = findViewById(R.id.txtChattingWith);
        ...
        imgSend.setOnClickListener(view -> {
            FirebaseDatabase.getInstance().getReference("messages/"+chatRoomId).push().setValue(new Message(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getEmail(),emailOfRoommate,edtMessageInput.getText().toString()));
        ...
        Glide.with(MessageActivity.this).load(getIntent().getStringExtra("img_of_roommate")).placeholder(R.drawable.ic_profilr).error(R.drawable.ic_profilr).into(imgToolbar);
